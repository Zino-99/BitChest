...
// Data component manages the user's profile information and updates
export default function Data() {
    // Retrieve user info from session storage, default to empty object
    const user = JSON.parse(sessionStorage.getItem('user') || '{}')
    ...
    // State hooks for feedback message and loading status
    const [message, setMessage] = useState(null)
    const [loading, setLoading] = useState(false)
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const body = { firstname, lastname, email }
            if (password) body.password = password // Include password if updated
